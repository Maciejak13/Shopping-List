...
namespace Shopping_List
{
    ...
    sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            ListDatabaseService.InitializeListDB(); //wczytaj tabele z listami. 
            ProductDatabaseService.InitializeHashProduct(); //wczytaj tabele hash.
        }
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (e.PrelaunchActivated == false)
            {
                if (rootFrame.Content == null)
                {
                    ...
                    // parametr
                    rootFrame.Navigate(typeof(MainMenu_Page), e.Arguments);
                }
